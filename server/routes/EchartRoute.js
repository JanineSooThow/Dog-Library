...
var eChartAPIDataController = require('../controllers/EchartController')

//define routes to the correct controller
router.get('/breeds/:breedgroup', eChartAPIDataController.fetchAPIData);//Going to the controller and calling this fetchAPIData
